...
- [x] **Queue Arcade & Trivia**: Built-in real-time browser mini-games or trivia where customers waiting can play against each other. The business owner can configure the winning reward (e.g., skip a spot, 10% discount, free coffee) based on what works best for their specific queue logic.
